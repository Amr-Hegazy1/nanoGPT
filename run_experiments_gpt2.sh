...
EXP6_DIR="out-gpt2-random-2d-recurrence-flat"
$TRAIN_CMD $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='flat' --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-flat" --out_dir=$EXP6_DIR --compile=False --batch_size=4
...
EXP7_DIR="out-gpt2-random-2d-recurrence-hierarchical"
$TRAIN_CMD $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='hierarchical' --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-hierarchical" --out_dir=$EXP7_DIR --compile=False --batch_size=4
