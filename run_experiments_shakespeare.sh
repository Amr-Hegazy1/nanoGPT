...
EXP7_DIR="out-shakespeare-char-random-2d-recurrence-flat"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='flat' --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-flat" --out_dir=$EXP7_DIR --compile=False --batch_size=12
...
EXP8_DIR="out-shakespeare-char-random-2d-recurrence-hierarchical"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='hierarchical' --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-hierarchical" --out_dir=$EXP8_DIR --compile=False --batch_size=12
...
EXP9_DIR="out-shakespeare-char-recurrent-shared-loss-scaling"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --scale_loss_by_n_layer=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-loss-scaling" --out_dir=$EXP9_DIR --compile=False --batch_size=24
...
EXP10_DIR="out-shakespeare-char-random-2d-recurrence-flat-loss-scaling"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='flat' --scale_loss_by_n_layer=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-flat-loss-scaling" --out_dir=$EXP10_DIR --compile=False --batch_size=12
...
EXP11_DIR="out-shakespeare-char-random-2d-recurrence-hierarchical-loss-scaling"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='hierarchical' --scale_loss_by_n_layer=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-hierarchical-loss-scaling" --out_dir=$EXP11_DIR --compile=False --batch_size=12
...
EXP12_DIR="out-shakespeare-char-recurrent-shared-moe"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --moe=True --share_moe_experts=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-moe" --out_dir=$EXP12_DIR --compile=False --batch_size=12
...
EXP13_DIR="out-shakespeare-char-recurrent-shared-moe-loss-scaling"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --moe=True --share_moe_experts=True --scale_loss_by_n_layer=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-moe-loss-scaling" --out_dir=$EXP13_DIR --compile=False --batch_size=12
...
EXP14_DIR="out-shakespeare-char-recurrent-shared-layer-dropout"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --layer_dropout=0.1 --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-layer-dropout" --out_dir=$EXP14_DIR --compile=False --batch_size=24
...
EXP15_DIR="out-shakespeare-char-recurrent-shared-sticky-dropout"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --sticky_dropout=0.1 --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-sticky-dropout" --out_dir=$EXP15_DIR --compile=False --batch_size=24
...
EXP16_DIR="out-shakespeare-char-recurrent-shared-learned-stopping"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --learned_stopping=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-learned-stopping" --out_dir=$EXP16_DIR --compile=False --batch_size=24
...
EXP17_DIR="out-shakespeare-char-random-2d-recurrence-flat-layer-dropout"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='flat' --layer_dropout=0.1 --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-flat-layer-dropout" --out_dir=$EXP17_DIR --compile=False --batch_size=12
...
EXP18_DIR="out-shakespeare-char-random-2d-recurrence-flat-sticky-dropout"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='flat' --sticky_dropout=0.1 --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-flat-sticky-dropout" --out_dir=$EXP18_DIR --compile=False --batch_size=12
...
EXP19_DIR="out-shakespeare-char-random-2d-recurrence-flat-learned-stopping"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='flat' --learned_stopping=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-flat-learned-stopping" --out_dir=$EXP19_DIR --compile=False --batch_size=12
...
EXP20_DIR="out-shakespeare-char-random-2d-recurrence-hierarchical-layer-dropout"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='hierarchical' --layer_dropout=0.1 --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-hierarchical-layer-dropout" --out_dir=$EXP20_DIR --compile=False --batch_size=12
...
EXP21_DIR="out-shakespeare-char-random-2d-recurrence-hierarchical-sticky-dropout"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='hierarchical' --sticky_dropout=0.1 --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-hierarchical-sticky-dropout" --out_dir=$EXP21_DIR --compile=False --batch_size=12
...
EXP22_DIR="out-shakespeare-char-random-2d-recurrence-hierarchical-learned-stopping"
python train.py $CONFIG --enable_random_2d_recurrence=True --random_2d_recurrence_type='hierarchical' --learned_stopping=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="random-2d-recurrence-hierarchical-learned-stopping" --out_dir=$EXP22_DIR --compile=False --batch_size=12
...
EXP23_DIR="out-shakespeare-char-recurrent-shared-moe-layer-dropout"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --moe=True --share_moe_experts=True --layer_dropout=0.1 --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-moe-layer-dropout" --out_dir=$EXP23_DIR --compile=False --batch_size=12
...
EXP24_DIR="out-shakespeare-char-recurrent-shared-moe-sticky-dropout"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --moe=True --share_moe_experts=True --sticky_dropout=0.1 --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-moe-sticky-dropout" --out_dir=$EXP24_DIR --compile=False --batch_size=12
...
EXP25_DIR="out-shakespeare-char-recurrent-shared-moe-learned-stopping"
python train.py $CONFIG --share_parameters_across_layers=True --recurrent_shared_weights=True --moe=True --share_moe_experts=True --learned_stopping=True --wandb_log=True --wandb_project=$WANDB_PROJECT --wandb_run_name="recurrent-shared-moe-learned-stopping" --out_dir=$EXP25_DIR --compile=False --batch_size=12
